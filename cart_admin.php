...
?>
    ...
    <td><a href='delete_cart2.php?oid=$result[oid]'><input type='submit' class='btn btn-outline-danger' value = 'Cancel' onclick = 'return checkdelete()'></a>
	
	<a href='complete.php?oid=$result[oid]'><input type='submit' class='btn btn-outline-success' value = 'Complete' onclick = 'return checkcomplete()'></a></td>
    </tr>
    ";
				}
			} else {
		...
		<center>
			<h6>Note: You can only proceed product checkout from the account you logged in from.</h6>
		</center>
	</body>
